...
import {
  organizationFilterAssign,
  organizationFilterReset,
} from "../../../store/maritime/organizations/OrganizationFilterSlice";
...
function SubHeaderComponent() {
  ...
  const filter_topic = useMemo(() => {
    return {
      ...
      Postcode: { id: "postcode_filter", topic: "Postcode" },
  ...
  return (
    // <div
    //   className="flex justify-between absolute -translate-y-full gap-2 w-full mt-12 p-1 
    // bg-gradient-to-r from-transparent via-blue-100 to-white z-2"
    // >
     ...
     rounded-t-3xl z-2 shadow-blue-950 shadow-2xl z-2">
      <div id="filterArea" className="ml-16 mr-20 flex gap-4 rounded-xl drop-shadow-2xl">
        ...
        <button
          ...
          onClick={() => {
            dispatch(organizationFilterReset());
          }}
        >
